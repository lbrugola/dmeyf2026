#!/bin/bash
# Corre 621_WorkFlow_01_junior_grupoB_Exp9112.ipynb (SIN MODIFICARLO) una vez por cada una de las
# 15 semillas del Experimento 9112, de a una, en secuencia.
#
...
# del tuning.
#
# El archivo original 621_WorkFlow_01_junior_grupoB_Exp9112.ipynb NUNCA se toca: se trabaja siempre
...
# Uso: nohup bash run_9112_15semillas.sh > "$HOME/log/z621_9112/nohup.out" 2>&1 &
#
...
# ubicada un nivel por debajo de donde esta 621_WorkFlow_01_junior_grupoB_Exp9112.ipynb
# (misma estructura relativa que en el repo).

cd "$(dirname "$0")" || exit 1

ORIGINAL="../621_WorkFlow_01_junior_grupoB_Exp9112.ipynb"
TRABAJO="621_WorkFlow_01_junior_grupoB_Exp9112_semilla_actual.ipynb"
...
echo "=== $(date '+%F %T') LAS 15 SEMILLAS DEL EXP 9112 TERMINARON. Resumen en $RESUMEN, detalle por semilla en $RESULTDIR/semilla_<N>/ ===" | tee -a "$LOGDIR/secuencial.log"
