...
Además en la carpeta interna de la VM llamada log, se debe crear una carpeta a donde se guardará la bitácora de ejecución del experimento, es decir habrá un archivo llamado secuencial.log con el detalle de la secuencia de ejecución de cada semilla del experimento. 
