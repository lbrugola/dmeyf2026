#!/bin/bash
# Corre 621_WorkFlow_01_junior_grupoB_Exp9117_GrupoA.ipynb (SIN MODIFICARLO) una vez por cada una de las
# 10 semillas del Grupo A de referencia para el Experimento 9117, de a una, en secuencia.
#
...
# y puede terminar eligiendo hiperparametros distintos: son 10 corridas
# independientes del pipeline original, no una version "robusta a semilla"
# del tuning.
#
# El archivo original 621_WorkFlow_01_junior_grupoB_Exp9117_GrupoA.ipynb NUNCA se toca: se trabaja siempre
...
# Uso: nohup bash run_9117_GrupoA_10semillas.sh > "$HOME/log/z621_9117_GrupoA/nohup.out" 2>&1 &
#
...
# ubicada un nivel por debajo de donde esta 621_WorkFlow_01_junior_grupoB_Exp9117_GrupoA.ipynb
# (misma estructura relativa que en el repo).

cd "$(dirname "$0")" || exit 1

ORIGINAL="../621_WorkFlow_01_junior_grupoB_Exp9117_GrupoA.ipynb"
TRABAJO="621_WorkFlow_01_junior_grupoB_Exp9117_GrupoA_semilla_actual.ipynb"
...
LOGDIR="$HOME/log/z621_9117_GrupoA"
...
# semillas para el Experimento 9117_GrupoA (10 semillas, Grupo A de referencia)
SEMILLAS=(116131 187211 322247 390263 430267 487649 522497 569321 906839 992689)

RESUMEN="$LOGDIR/resumen_9117_GrupoA.txt"
...
echo "=== $(date '+%F %T') LAS 10 SEMILLAS DEL EXP 9117 TERMINARON. Resumen en $RESUMEN, detalle por semilla en $RESULTDIR/semilla_<N>/ ===" | tee -a "$LOGDIR/secuencial.log"
