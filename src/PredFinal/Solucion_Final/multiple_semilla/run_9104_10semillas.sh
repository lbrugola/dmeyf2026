...
ORIGINAL="../729_final_junior_Luciano_Brugola_Exp9104_multi_semilla.ipynb"
TRABAJO="729_final_junior_Luciano_Brugola_Exp9104_semilla_actual.ipynb"
...
WF_EXPERIMENTO=9104_multi

LOGDIR="$HOME/log/729_9104_multi"
